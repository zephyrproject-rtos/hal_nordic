...
typedef enum {
    ...
    NRFX_ANALOG_INTERNAL_VDDAO1V8, ///< Internal VDDA - 1.8V
    NRFX_ANALOG_INTERNAL_VDDAO0V8, ///< Internal VDDA - 0.8V
    NRFX_ANALOG_INTERNAL_VDDRF,    ///< Internal VDDRF
    NRFX_ANALOG_INTERNAL_VBAT,     ///< Internal VBAT
