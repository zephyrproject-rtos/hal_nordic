...
/** @brief USB service event handler type. */
typedef void (*nrfs_usb_evt_handler_t)(nrfs_usb_evt_t const * p_evt, void * context);

/**
 * @brief Function for initializing the USB service.
 *
...
/**
 * @brief Function for uninitializing the USB service.
 *
...
/**
 * @brief Function for requesting USBHSPLL and VREGUSB to be enabled and configured in USB service.
 *
...
/**
 * @brief Function for requesting USBHSPLL and VREGUSB to be disabled in USB service.
 *
 * @param[in] p_context Pointer to the context to be associated with request.
 *
 * @retval NRFS_SUCCESS           Request sent successfully.
