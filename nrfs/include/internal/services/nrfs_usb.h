...
/** @brief USB service notification data structure for enable request. */
...
/** @brief USB service enable request structure. */
typedef struct __NRFS_PACKED {
	nrfs_hdr_t hdr; /**< Header of the message. */
	nrfs_ctx_t ctx; /**< Context of the message. */
} nrfs_usb_enable_req_t;

/** @brief USB service disable request structure. */
typedef struct __NRFS_PACKED {
	nrfs_hdr_t hdr; /**< Header of the message. */
	nrfs_ctx_t ctx; /**< Context of the message. */
} nrfs_usb_disable_req_t;

/** @brief USB service notification structure for enable request. */
typedef struct __NRFS_PACKED {
	nrfs_hdr_t hdr;		  /**< Header of the message. */
	nrfs_ctx_t ctx;		  /**< Context of the message. */
