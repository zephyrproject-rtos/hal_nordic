...
enum {
	...
	NRFS_USB_REQ_LD_BOOLEAN_ENABLE  = NRFS_REQUEST_ID_DEF(NRFS_SERVICE_ID_USB, 0x03),
	NRFS_USB_REQ_LD_BOOLEAN_DISABLE = NRFS_REQUEST_ID_DEF(NRFS_SERVICE_ID_USB, 0x04),
};
