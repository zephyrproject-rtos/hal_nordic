...
/**
 * @file
 *   This file contains implementation of the nRF 802.15.4 high precision timer
 *   abstraction.
 *
 * This implementation is built on top of the TIMER peripheral.
 * If SoftDevice RAAL is in use the TIMER peripheral is shared between RAAL and
 * this module.
 *
 */
