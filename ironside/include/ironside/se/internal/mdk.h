...
/* Override the UICR structure from the MDK with the IronSide UICR. */
#if !defined(NRF_APPLICATION_UICR_NS_BASE)
#error "Expected NRF_APPLICATION_UICR_NS_BASE to be defined"
#endif
...
#define NRF_UICR_BASE        NRF_APPLICATION_UICR_NS_BASE
#define NRF_UICR             ((struct UICR *)NRF_UICR_BASE)
#define NRF_APPLICATION_UICR NRF_UICR
